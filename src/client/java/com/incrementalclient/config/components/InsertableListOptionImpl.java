...
@ApiStatus.Internal
public final class InsertableListOptionImpl<T> implements ListOption<T> {
    ...
    private class EntryFactory {
        ...
        public ListOptionEntry<T> create(T initialValue) {
            return new InsertableListOptionEntryImpl<>(InsertableListOptionImpl.this, initialValue, controllerFunction);
        }
    }
    ...
    public static final class BuilderImpl<T> implements Builder<T> {
        ...
        public ListOption<T> build() {
            ...
            return new InsertableListOptionImpl<>(name, description, stateManager, initialValue, controllerFunction, ImmutableSet.copyOf(flags), collapsed, available, minimumNumberOfEntries, maximumNumberOfEntries, insertEntriesAtEnd, listeners);
        }
    }
}