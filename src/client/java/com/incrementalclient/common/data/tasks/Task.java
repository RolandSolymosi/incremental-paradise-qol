...
public enum Task {
    ...
    W2_SkyBeetle(new NormalTask("Sky Beetle", Region.W2_Overworld, List.of("skybeetles"), null, TaskType.Foraging, DefaultWardrobe.Foraging, Tool.Axe, null, List.of(Warp.W2_Spawn))),

    W2_Panda(new NormalTask("Panda", Region.W2_Overworld, List.of("pandas"), null, TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, null, List.of(Warp.W2_Sky, Warp.W2_Spawn))),
    W2_Sniffer(new NormalTask("Sniffer", Region.W2_Overworld, List.of("sniffers"), null, TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, null, List.of(Warp.W2_Forge, Warp.W2_Spawn))),
    ...
    W2_W2Elite(new NormalTask("Elite mobs in World #2", Region.W2_Overworld, List.of("mobs in world #2"), List.of(Constraint.Elite), TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, null, List.of(Warp.W2_Infernal, Warp.W2_Veil, Warp.W2_Lush, Warp.W2_Spawn))),
    ...
    W2_Salmon(new NormalTask("Salmon", Region.W2_Overworld, List.of("salmon"), null, TaskType.Fishing, DefaultWardrobe.Fishing, Tool.Spear, null, List.of(Warp.W2_Spawn))),
