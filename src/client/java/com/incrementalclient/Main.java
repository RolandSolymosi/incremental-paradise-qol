...
public class Main implements ClientModInitializer {
    ...
    public static final ServiceProvider SERVICE_PROVIDER = new ServiceCollection()
            ...
            .addSingleton(ScoreboardReplacementBarElement.class).forwardSingleton(Configurable.class, ScoreboardReplacementBarElement.class).forwardSingleton(HudElement.class, ScoreboardReplacementBarElement.class)
