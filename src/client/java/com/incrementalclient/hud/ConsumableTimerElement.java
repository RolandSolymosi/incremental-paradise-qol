...
public class ConsumableTimerElement extends TextListHudElement<ConsumableTimerElement.Configuration> {
        ...
        options = Suppliers.memoize(() -> List.of(
                ...
                Categories.Hud.Consumable.createConfig(1,
                        Option.<Double>createBuilder()
                                ...
                                .binding(configuration.defaultConsumableHudBackgroundOpacity, () -> configuration.consumableHudBackgroundOpacity, newVal -> configuration.consumableHudBackgroundOpacity = newVal)
                ...
                Categories.Hud.Consumable.createConfig(2,
                        Option.<Color>createBuilder()
                                ...
                                .binding(new Color(configuration.defaultConsumableTimerColor), () -> new Color(configuration.consumableTimerColor), newVal -> configuration.consumableTimerColor = newVal.getRGB())
                ...
                Categories.Hud.Consumable.createConfig(3,
                        Option.<Color>createBuilder()
                                ...
                                .binding(new Color(configuration.defaultConsumableTimeColor), () -> new Color(configuration.consumableTimeColor), newVal -> configuration.consumableTimeColor = newVal.getRGB())
                                .controller(ColorControllerBuilder::create)
                                .build())
        ));
    }
    ...
    public static class Configuration extends HudElement.ConfigurationBase {
        ...
        @SerialEntry
        public int consumableTimerColor = defaultConsumableTimerColor;
        @SerialEntry
        public int consumableTimeColor = defaultConsumableTimeColor;
    }
}
