...
@ApiStatus.Internal
public final class InsertableListOptionEntryImpl<T> implements ListOptionEntry<T> {
    private final InsertableListOptionImpl<T> group;
    ...
    InsertableListOptionEntryImpl(InsertableListOptionImpl<T> group, T initialValue, @NotNull Function<ListOptionEntry<T>, Controller<T>> controlGetter) {
        this.group = group;
     ...
     */
    @ApiStatus.Internal
    public record EntryController<T>(Controller<T> controller, InsertableListOptionEntryImpl<T> entry) implements Controller<T> {
        @Override
        ...
        public AbstractWidget provideWidget(YACLScreen screen, Dimension<Integer> widgetDimension) {
            return new InsertableListEntryWidget(screen, entry, controller.provideWidget(screen, widgetDimension));
        }
    }
