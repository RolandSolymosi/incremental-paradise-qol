...
public class Loadouts extends ListenableBase<Listener> implements ComplexConfigurable<Loadouts.Configuration, ListOption<Loadouts.Configuration.Loadout>> {
    ...
    private ListOption<Configuration.Loadout> createScreen(){
        return InsertableListOption.<Configuration.Loadout>createBuilder()
    ...
    @Override
    public ListOption<Loadouts.Configuration.Loadout> getOption() {
        return options.get();
    }
    ...
    public void optionChanged() {
        ...
        for (var savedHotkey : configuration.hotheys) {
            var keyBindListener = new KeyBindMonitor.KeyBindListener(new KeyBinding(
