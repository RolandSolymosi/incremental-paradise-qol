...
public enum Task {
    ...
    Apple(new NormalTask("Apple", Region.W1_Overworld, List.of("apples"), null, TaskType.Foraging, DefaultWardrobe.Foraging, Tool.Axe, List.of(Target.W1_AppleTree), List.of(Warp.W1_Spawn))),
    ...
    MountainGoat(new NormalTask("Mountain Goat", Region.W1_Overworld, List.of("mountain goats"), null, TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, List.of(Target.W1_Goat), List.of(Warp.W1_Spawn))),
    WildBoar(new NormalTask("Wild Boar", Region.W1_Overworld, List.of("wild boars"), null, TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, List.of(Target.W1_WildBoar), List.of(Warp.W1_Hoglin, Warp.W1_Spawn))),
...
//    ShinyPetrafin(new NormalTask("Shiny petrafin", Region.W4_Delta, List.of("petrafin"), List.of(Constraint.Shiny), TaskType.Mining, DefaultWardrobe.Mining, Tool.Pickaxe, List.of(Target.W4_Petrafin), List.of(Warp.W4_Delta))),
    ...
    PiglinWithDevilsGambit(new NormalTask("Piglin with Devil's Gambit", Region.WN1_Overworld, List.of("piglins"), List.of(Constraint.DevilsGambit), TaskType.Combat, DefaultWardrobe.Combat, Tool.Melee, List.of(Target.N1_Piglin), List.of(Warp.WN1_Spawn))),
    ...
    BamboodleWithDevilsGambit(new NormalTask("Bamboodle with Devil's gambit", Region.WN1_Overworld, List.of("bamboodles"), List.of(Constraint.DevilsGambit), TaskType.Combat, DefaultWardrobe.Combat, Tool.Bow, List.of(Target.N1_Bamboodle), List.of(Warp.WN1_Bamboodle, Warp.WN1_Zoglin, Warp.WN1_Decay, Warp.WN1_Spawn))),
    ...
    FirefoxWithDevilsGambit(new NormalTask("Firefox with Devil's Gambit", Region.WN1_Overworld, List.of("firefoxes"), List.of(Constraint.DevilsGambit), TaskType.Combat, DefaultWardrobe.Combat, Tool.Bow, List.of(Target.N1_Firefox), List.of(Warp.WN1_Firefox, Warp.WN1_Spawn))),
    ...
    MandrakeWithLandscaping(new NormalTask("Mandrake with %s+ Landscaping leaves", Region.WN1_Overworld, List.of("mandrakes"), List.of(Constraint.Landscaping), TaskType.Farming, DefaultWardrobe.Farming, Tool.Hoe, null, List.of(Warp.WN1_Mandrake, Warp.WN1_Spawn))),
    ...
    SplinterseedWithLandscaping(new NormalTask("Splinterseed with %s+ Landscaping leaves", Region.WN1_Overworld, List.of("splinterseed"), List.of(Constraint.Landscaping), TaskType.Farming, DefaultWardrobe.Farming, Tool.Hoe, null, List.of(Warp.WN1_Splinterseed, Warp.WN1_Stable, Warp.WN1_Spawn))),
